...
%=============================================================================
    if ( isequal(T,Tver) & check==1 )
        ...
        LAM = [1/3,1/3,1/3];
        for i=1:3
            [PVAL,~]= HCT_PVALi(X,Y, LCOEFV(i,1:10), i, LAM);
        ...
        for i=1:3
            fprintf('\nsubtriangle %d:\n',i);
            [LAMout1,~,~]= HCT_LAMin2out(X,Y,[1,0,0],i);
            [LAMout2,~,~]= HCT_LAMin2out(X,Y,[0,1,0],i);
            [LAMout3,~,~]= HCT_LAMin2out(X,Y,[0,0,1],i);
            [LAMoutC,~,~]= HCT_LAMin2out(X,Y,[1/3,1/3,1/3],i);
            [~,DelP1]= HCT_PVALi(X,Y, LCOEFV(i,1:10), i, LAMout1);
            [~,DelP2]= HCT_PVALi(X,Y, LCOEFV(i,1:10), i, LAMout2);
            [~,DelP3]= HCT_PVALi(X,Y, LCOEFV(i,1:10), i, LAMout3);
            [~,DelPC]= HCT_PVALi(X,Y, LCOEFV(i,1:10), i, LAMoutC);
        ...
        for i=1:3
            ...
            [PVAL1,~]= HCT_PVALi(X,Y, LCOEFV(order(i+1),1:10), order(i+1), LAM);
            [PVAL2,~]= HCT_PVALi(X,Y, LCOEFV(order(i+2),1:10), order(i+2), LAM);
